...
class RequestServiceImplTest {
    ...
    void addRequestDTO_success() {
        ...
        assertEquals(outputResponse, requestServiceImpl.addRequestDTO(1L, requestDTOResponse));
    ...
    void addRequestDTO_whenUserNotFound_thenThrowsException() {
        ...
        assertThrows(NotFoundException.class, () -> requestServiceImpl.addRequestDTO(1L, requestDTOResponse));
    }
    ...
    void getRequestById_found_success() {
        ...
        when(requestMapperResponse.toDTO(any(Request.class))).thenReturn(outputResponse);
        assertEquals(outputResponse, requestServiceImpl.getRequestById(1L, 1L));
    ...
    void getRequestById_whenUserNotFound_thenThrowsException() {
        when(userRepository.findById(1L)).thenReturn(Optional.empty());
        assertThrows(NotFoundException.class, () -> requestServiceImpl.getRequestById(1L, 1L));
    }
}
